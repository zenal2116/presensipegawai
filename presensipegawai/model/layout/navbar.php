...
<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">         <span class="sr-only">Toggle navigation</span>
  ...
  <a class="navbar-brand" href="home">PRESENSI ONLINE</a>
  </div>
...
<?php
	if (isset($_SESSION['pb'])) {
			...
			$name=array("","TAMBAH PEGAWAI","DAFTAR PEGAWAI","ABSEN","ABSENSI PEGAWAI","KINERJA","KINERJA PEGAWAI","UBAH KATA SANDI", "KELUAR");
			...
			$name=array("","ABSEN","ABSENSI PEGAWAI","KINERJA ","KINERJA PEGAWAI","KELUAR");
