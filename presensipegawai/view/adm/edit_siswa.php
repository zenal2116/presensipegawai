<?php 
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="name">ID Pegawai:</label>
    <div class="col-sm-10">
      <input type="number" value="<?php echo $nis_user; ?>" class="form-control" name="nis" placeholder="Masukan ID Pegawai" required>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" value="<?php echo $sklh_user; ?>" class="form-control" name="sklh" placeholder="Masukan Jabatan" required>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      ...
      <button type="button" onclick="hapusPegawai(<?php echo $id_user; ?>)" class="btn btn-danger" name="">Hapus Pegawai</button>
    </div>
  </div>
</form>
<?php
